...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Returns Sue instead of Bob first because it behaves as a Stack (LIFO) instead of Queue (FIFO).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Behaving as LIFO (Stack). Also does not re-enqueue people with infinite turns (turns == 0).
    ...
    // Defect(s) Found: None found in this specific test.
